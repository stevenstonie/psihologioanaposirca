...
export default function AntiSuicideBanner() {
    return (
        <div className="crisis-banner-viewport">
            <div className="crisis-banner-track">
                {/* primary group */}
                ...
                {/* duplicate group hidden from screen readers to prevent double reading */}
                <div className="crisis-group" aria-hidden="true">
                    <BannerItem />
                    <BannerItem />
                </div>
            </div>
